                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-sm font-medium text-neutral-800 dark:text-neutral-600 mb-3">
                                        <em>{pub.journal || pub.conference}</em>, {pub.year}{pub.volume ? `, ${pub.volume}` : ''}{pub.issue ? `(${pub.issue})` : ''}{pub.pages ? `: ${pub.pages}` : ''}
                                    </p>
                                    ...
                                    {pub.metrics && pub.metrics.length > 0 && (
                                        <div className="flex flex-wrap gap-2 mb-3">
                                            {pub.metrics.map((metric) => (
                                                <span
                                                    key={metric}
                                                    className="inline-flex items-center rounded border border-neutral-200 dark:border-neutral-700 px-2 py-0.5 text-xs font-medium text-neutral-600 dark:text-neutral-400"
                                                >
                                                    {metric}
                                                </span>
                                            ))}
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-auto">
                                        {pub.doi && (
                                            <a
                                                ...
                                                className="inline-flex items-center px-3 py-1 rounded-md text-xs font-medium bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300 hover:bg-blue-600 hover:text-white transition-colors"
                                            >
                                                DOI
                                            </a>
                                        )}
